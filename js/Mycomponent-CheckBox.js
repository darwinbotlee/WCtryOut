...
class MycomponentCheckBox extends HTMLElement {
	static get observedAttributes() {
		return ['checked', 'disabled'];
	}	
	
	
	//The element's constructor is run anytime a new instance is created. Instances are created either by parsing HTML, calling document.createElement('howto-checkbox'), or calling new Mycomponent-CheckBox(); The construtor is a good place to create shadow DOM, though you should avoid touching any attributes or light DOM children as they may not be available yet.
    constructor() {
		super();
	...
	//A user may set a property on an instance of an element, before its prototype has been connected to this class. The _upgradeProperty() method will check for any instance properties and run them through the proper class setters. See the lazy properites section for more details.
...
window.customElements.define('mycomponent-checkbox', MycomponentCheckBox);
